...
#pragma warning(disable:4311) //C4311: 'type cast' : pointer truncation from 'coff_symbol_type *' to 'bfd_hostptr_t'
#pragma warning(disable:4312) //C4312: 'type cast': conversion from 'bfd_hostptr_t' to 'coff_symbol_type *' of greater size
#pragma warning(disable:4333) //C4333: '>>' : right shift by too large amount, data loss
